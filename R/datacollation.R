...
get_cor_summary <- function(summary, col_names_list, num_parameters, min_count, Verbose=FALSE,ReturnCI=FALSE, CombinedMutationRate =FALSE, CombinedFitnessEffect=FALSE, CombinedPassengerMutationRate=FALSE ) {
